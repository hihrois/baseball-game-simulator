...
batting_stats/sample.csv exsits initially, so refer it when you have something ambigious.  
...
Initially, average runs and standard deviation are available only.  

(Sorry for poor. That is one of the function we should update soon... You can expand it, of course)
